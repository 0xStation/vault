...
api: "PUT https://api.station.express/api/erc721/defaultMetadata"
---
...
Individual metadata can be set when [minting new NFTs](/token-api/erc721/post/mint) or [editing their metadata](/token-api/erc721/put/individualMetadata) directly, which will override the defaults set here.
...
curl --location --request PUT 'https://api.station.express/api/erc721/defaultMetadata' \
