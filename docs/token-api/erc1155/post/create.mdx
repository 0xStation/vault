...
api: "POST https://api.station.express/api/erc1155/create"
---
...
<ParamField body="network" type="string" default="polygon">
  The name of the network for this token. This cannot be changed after creation.
</ParamField>
...
curl --location --request POST 'https://api.station.express/api/erc1155/create' \
