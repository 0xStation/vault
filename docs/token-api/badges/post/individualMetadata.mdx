...
api: "POST https://api.station.express/api/erc721/individualMetadata"
description: "Update individual metadata for a specific NFT."
---
...
This metadata can be set when [minting an NFT](/token-api/badges/post/mint) or edited retroactively through this route.
