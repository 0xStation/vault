...
api: "GET https://api.station.express/api/holders"
...
curl --location --request POST 'https://api.station.express/api/holders?contractAddresses=[0xba767d65a7164e151783e42994bd475509f256dd]' \
