...
api: "PUT https://members.station.express/api/v1/erc721/individualMetadata"
---
...
curl --location --request PUT 'https://members.station.express/api/v1/erc721/individualMetadata' \
