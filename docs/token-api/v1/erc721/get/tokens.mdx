...
api: "GET https://api.station.express/api/v1/erc721/tokens"
...
curl --location --request POST 'https://api.station.express/api/v1/erc721/tokens?contractAddress=0x67F4732266C7300cca593C814d46bee72e40659F' \
