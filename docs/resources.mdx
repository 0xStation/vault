...
<CardGroup>
  <Card
    ...
    icon="browser"
    href="https://mintlify.com/docs/settings/custom-domain/subdomain"
  >
  ...
  <Card
    ...
    href="https://mintlify.com/docs/components/advanced/accordion"
  >
  ...
  <Card
    ...
    icon="square-code"
    href="https://mintlify.com/docs/api-components/overview"
  >
  ...
  <Card
    title="Analytics"
    icon="chart-mixed"
    href="https://mintlify.com/docs/analytics/supported-integrations"
  >
