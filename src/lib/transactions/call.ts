...
export type RawCall = {
  ...
  value: string
  data: string
  operation?: number // 0 for call, 1 for delegatecall. This property is optional mainly because it causes the safe execution transaction to fail if it's included
}
