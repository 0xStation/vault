...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    className={cn(
      "mb-[-4px] inline-flex items-center justify-center pb-1 text-sm text-white disabled:pointer-events-none disabled:opacity-50 data-[state=active]:border-b data-[state=active]:font-bold",
      className,
    )}
    {...props}
    ref={ref}
